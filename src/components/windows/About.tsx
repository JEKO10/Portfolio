        ...
        >
          <AboutHandle className="handle">
            ...
            <AboutMeText>
              ...
              always loved to play games and I kept wondering how to make my
              own. I started with basic programming, through game development,
              to the web development. Since then I haven’t stopped learning web
              development. I have a passion for building awesome websites and
              functional web applications. I am a quick learner and fully
              committed to growing my skills. Additionally, I am always willing
              to keep learning new technologies. When I’m not coding, I play
