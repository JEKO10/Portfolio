 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Zp=Y,Hp=Symbol.for("react.element"),Vp=Symbol.for("react.fragment"),Wp=Object.prototype.hasOwnProperty,Xp=Zp.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,qp={key:!0,ref:!0,__self:!0,__source:!0};function LA(e,t,n){var r,o={},i=null,l=null;n!==void 0&&(i=""+n),t.key!==void 0&&(i=""+t.key),t.ref!==void 0&&(l=t.ref);for(r in t)Wp.call(t,r)&&!qp.hasOwnProperty(r)&&(o[r]=t[r]);if(e&&e.defaultProps)for(r in t=e.defaultProps,t)o[r]===void 0&&(o[r]=t[r]);return{$$typeof:Hp,type:e,key:i,ref:l,props:o,_owner:Xp.current}}bi.Fragment=Vp;bi.jsx=LA;bi.jsxs=LA;(function(e){e.exports=bi})(Qp);const Tt=Jr.Fragment,x=Jr.jsx,V=Jr.jsxs;var Jl={},Zr={},$p={get exports(){return Zr},set exports(e){Zr=e}},at={},Zl={},_p={get exports(){return Zl},set exports(e){Zl=e}},NA={};/**
 * @license React
...
`,X0=()=>{const{isOpen:e,setIsOpen:t,setIsVisible:n,isVisible:r,setIsShutDown:o,setIsShuttingDown:i}=Pe(),l=[{name:"about",src:ul,alt:"aboutStart",label:"About Me"},{name:"work",src:cl,alt:"workStart",label:"My Work"},{name:"contact",src:Al,alt:"contactStart",label:"Contact"},{name:"recycle",src:po,alt:"RecycleStart",label:"Recycle Bin"}],a=()=>{i(!0),setTimeout(()=>{o(!0)},3e3)};return V(W0,{isOpen:e.start,"data-no-select":"true",children:[l.map(s=>V(DA,{onClick:()=>{t({...e,[s.name]:!0,start:!1}),n({...r,[s.name]:!0})},children:[x("img",{src:s.src,alt:s.alt}),x("p",{children:s.label})]},s.name)),x("img",{src:H0,alt:"StartDash"}),V(DA,{onClick:a,children:[x("img",{src:Z0,alt:"ShutDownStart"}),x("p",{children:"Shut Down"})]})]})},q0="/Portfolio/assets/timeModal-6454d07c.jpg",$0=G.section`
...
`,cy=()=>{const[e,t]=Y.useState(new Date);Y.useEffect(()=>{const r=setInterval(()=>{t(new Date)},1e3);return()=>clearInterval(r)},[]);const n=r=>({transform:`rotate(${r}deg)`});return V(ay,{children:[x(sy,{style:n(e.getHours()*30)}),x(uy,{style:n(e.getMinutes()*6)}),x(Ay,{style:n(e.getSeconds()*6)})]})},fy=({time:e})=>{const t=["January","February","March","April","May","June","July","August","September","October","November","December"],n=e.toLocaleDateString("en-US",{timeZoneName:"longGeneric"}),r=e.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0});return V(Tt,{children:[V("article",{children:[x(ny,{children:t[e.getMonth()]}),x(ty,{children:e.getFullYear()}),x(ry,{children:n.split(", ")[1]})]}),V("article",{children:[x(cy,{}),x(ey,{children:r})]})]})},py=()=>{const{lastClicked:e,setLastClicked:t}=Pe(),[n,r]=Y.useState(new Date),{isLoading:o}=xr();return Y.useEffect(()=>{const i=setInterval(()=>{r(new Date)},1e3);return()=>{clearInterval(i)}},[]),x(Tt,{children:x(Ot,{handle:".handle",bounds:"body",children:V($0,{onMouseDownCapture:()=>t("time"),isLoading:o,lastClicked:e,"data-no-select":"true",children:[x(_0,{className:"handle"}),x(fy,{time:n}),x(oy,{})]})})})},dy="/Portfolio/assets/workModal-d51c54ee.jpg",hy="/Portfolio/assets/workModalSmall-c401032c.jpg",gy=G.section`
...
`,Yy=()=>{const[e,t]=Y.useState(new Date),{setIsOpen:n,isOpen:r}=Pe(),o=Kn();Y.useEffect(()=>{const l=setInterval(()=>{t(new Date)},1e3);return()=>{clearInterval(l)}},[]);const i=e.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",hour12:!1});return V(Ny,{children:[x(Ip,{src:Ep,alt:"dash",place:"tool"}),V(Gy,{onClick:()=>{n({...r,time:!r.time})},children:[x("img",{src:Ly,alt:"toolButton"}),x(Fy,{onClick:()=>n({...r,time:!r.time}),children:o<480?i.slice(0,2):i})]})]})},Jy=()=>{const{isOpen:e}=Pe(),t=Kn(),n=[{iconName:"about",imgSource:ul,label:"About me",isVisible:e.about},{iconName:"work",imgSource:cl,label:"Work",isVisible:e.work},{iconName:"contact",imgSource:Al,label:"Contact",isVisible:e.contact},{iconName:"recycle",imgSource:po,label:"Recycle Bin",isVisible:e.recycle},{iconName:"book",imgSource:Yr,label:"Book",isVisible:e.book}];return x(Tt,{children:V(Uy,{"data-no-select":"true",children:[V("article",{children:[x(Ky,{}),x(Ip,{src:Ep,alt:"dash",place:"task"}),t>768&&x(RA,{iconName:"name",imgSource:"",label:"Aleksa Bubanja"}),n.map(r=>r.isVisible&&x(RA,{iconName:r.iconName,imgSource:r.imgSource,label:r.label},r.iconName))]}),x(Yy,{})]})})},Zy=()=>{const[e,t]=Y.useState(!1),[n,r]=Y.useState(!1),[o,i]=Y.useState({x:0,y:0}),[l,a]=Y.useState({x:0,y:0}),{isClicked:s,setIsClicked:u,setIsOpen:m,isOpen:h}=Pe(),p={about:{x:30,y:35,height:140,width:116},work:{x:30,y:215,height:140,width:116},contact:{x:30,y:395,height:140,width:116},recycle:{x:1530,y:680,height:140,width:116}};return V(tm,{className:"home",onMouseDown:R=>{const c=R.clientX,A=R.clientY;if(!R.target.closest("[data-no-select='true']")){for(const S in p){const B=p[S];if(c>=B.x&&c<=B.x+B.width&&A>=B.y&&A<=B.y+B.height)return}R.preventDefault(),t(!0),r(!0),i({x:c,y:A}),a({x:c,y:A}),m({...h,start:!1})}},onMouseUp:()=>{t(!1),r(!1)},onMouseMove:R=>{if(e){a({x:R.clientX,y:R.clientY});const c={x:Math.min(o.x,l.x),y:Math.min(o.y,l.y),width:Math.abs(l.x-o.x),height:Math.abs(l.y-o.y)},A={};for(const d in p){const S=p[d];S.x<c.x+c.width&&S.x+S.width>c.x&&S.y<c.y+c.height&&S.y+S.height>c.y?A[d]=!0:A[d]=!1}u({...s,...A})}},children:[n&&x("div",{style:{position:"absolute",border:"2px solid gray",pointerEvents:"none",top:`${Math.min(o.y,l.y)}px`,left:`${Math.min(o.x,l.x)}px`,width:`${Math.abs(l.x-o.x)}px`,height:`${Math.abs(l.y-o.y)}px`}}),x(My,{}),x(ky,{}),x(Jy,{})]})},Hy="/Portfolio/assets/preloader-fe69a455.jpg",Vy="/Portfolio/assets/preloaderSmall-d50a5df1.jpg",Wy=G.div`
  ${he({justify:"center",align:"center"})};
...
`,MA=({preloader:e})=>x("section",{children:V(Wy,{children:[x(Xy,{}),!e&&x("p",{children:"Windows is shutting down."})]})}),qy="/Portfolio/assets/turnOn-e9c9c3b4.png",$y=G.section`
  ${he({justify:"center",align:"center"})};
...
`,_y=()=>{const{setIsShutDown:e,setIsLoading:t,setIsOpen:n,setIsShuttingDown:r}=Pe(),o=()=>{t(!0),setTimeout(()=>{t(!1)},3e3)};return x($y,{children:x("button",{onClick:()=>{r(!1),e(!1),o(),n({about:!1,work:!1,contact:!1,recycle:!1,time:!1,book:!1})}})})};function e1(){const{isShutDown:e,isLoading:t,setIsLoading:n,isShuttingDown:r}=Pe();return Y.useEffect(()=>{n(!0);const o=setTimeout(()=>{n(!1)},3e3);return()=>clearTimeout(o)},[n]),V("main",{children:[x(em,{}),x(_g,{}),r&&!e?x(MA,{preloader:!1}):e?x(_y,{}):V("div",{children:[t&&x(MA,{preloader:!0}),x(Zy,{})]})]})}Jl.createRoot(document.getElementById("root")).render(x(Tn.StrictMode,{children:x(s0,{children:x(e1,{})})}));
