 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(Q,N){var z=Q.length;Q.push(N);e:for(;0<z;){var te=z-1>>>1,g=Q[te];if(0<o(g,N))Q[te]=N,Q[z]=g,z=te;else break e}}function n(Q){return Q.length===0?null:Q[0]}function r(Q){if(Q.length===0)return null;var N=Q[0],z=Q.pop();if(z!==N){Q[0]=z;e:for(var te=0,g=Q.length,y=g>>>1;te<y;){var v=2*(te+1)-1,C=Q[v],f=v+1,P=Q[f];if(0>o(C,z))f<g&&0>o(P,C)?(Q[te]=P,Q[f]=z,te=f):(Q[te]=C,Q[v]=z,te=v);else if(f<g&&0>o(P,z))Q[te]=P,Q[f]=z,te=f;else break e}}return N}function o(Q,N){var z=Q.sortIndex-N.sortIndex;return z!==0?z:Q.id-N.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var l=Date,a=l.now();e.unstable_now=function(){return l.now()-a}}var s=[],u=[],m=1,h=null,p=3,w=!1,k=!1,E=!1,R=typeof setTimeout=="function"?setTimeout:null,c=typeof clearTimeout=="function"?clearTimeout:null,A=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function d(Q){for(var N=n(u);N!==null;){if(N.callback===null)r(u);else if(N.startTime<=Q)r(u),N.sortIndex=N.expirationTime,t(s,N);else break;N=n(u)}}function S(Q){if(E=!1,d(Q),!k)if(n(s)!==null)k=!0,mt(B);else{var N=n(u);N!==null&&ae(S,N.startTime-Q)}}function B(Q,N){k=!1,E&&(E=!1,c(M),M=-1),w=!0;var z=p;try{for(d(N),h=n(s);h!==null&&(!(h.expirationTime>N)||Q&&!me());){var te=h.callback;if(typeof te=="function"){h.callback=null,p=h.priorityLevel;var g=te(h.expirationTime<=N);N=e.unstable_now(),typeof g=="function"?h.callback=g:h===n(s)&&r(s),d(N)}else r(s);h=n(s)}if(h!==null)var y=!0;else{var v=n(u);v!==null&&ae(S,v.startTime-N),y=!1}return y}finally{h=null,p=z,w=!1}}var b=!1,O=null,M=-1,_=5,J=-1;function me(){return!(e.unstable_now()-J<_)}function ye(){if(O!==null){var Q=e.unstable_now();J=Q;var N=!0;try{N=O(!0,Q)}finally{N?Ie():(b=!1,O=null)}}else b=!1}var Ie;if(typeof A=="function")Ie=function(){A(ye)};else if(typeof MessageChannel<"u"){var Te=new MessageChannel,Re=Te.port2;Te.port1.onmessage=ye,Ie=function(){Re.postMessage(null)}}else Ie=function(){R(ye,0)};function mt(Q){O=Q,b||(b=!0,Ie())}function ae(Q,N){M=R(function(){Q(e.unstable_now())},N)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(Q){Q.callback=null},e.unstable_continueExecution=function(){k||w||(k=!0,mt(B))},e.unstable_forceFrameRate=function(Q){0>Q||125<Q?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):_=0<Q?Math.floor(1e3/Q):5},e.unstable_getCurrentPriorityLevel=function(){return p},e.unstable_getFirstCallbackNode=function(){return n(s)},e.unstable_next=function(Q){switch(p){case 1:case 2:case 3:var N=3;break;default:N=p}var z=p;p=N;try{return Q()}finally{p=z}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(Q,N){switch(Q){case 1:case 2:case 3:case 4:case 5:break;default:Q=3}var z=p;p=Q;try{return N()}finally{p=z}},e.unstable_scheduleCallback=function(Q,N,z){var te=e.unstable_now();switch(typeof z=="object"&&z!==null?(z=z.delay,z=typeof z=="number"&&0<z?te+z:te):z=te,Q){case 1:var g=-1;break;case 2:g=250;break;case 5:g=1073741823;break;case 4:g=1e4;break;default:g=5e3}return g=z+g,Q={id:m++,callback:N,priorityLevel:Q,startTime:z,expirationTime:g,sortIndex:-1},z>te?(Q.sortIndex=z,t(u,Q),n(s)===null&&Q===n(u)&&(E?(c(M),M=-1):E=!0,ae(S,z-te))):(Q.sortIndex=g,t(s,Q),k||w||(k=!0,mt(B))),Q},e.unstable_shouldYield=me,e.unstable_wrapCallback=function(Q){var N=p;return function(){var z=p;p=N;try{return Q.apply(this,arguments)}finally{p=z}}}})(NA);(function(e){e.exports=NA})($p);/**
 * @license React
...
`,W0=()=>{const{isOpen:e,setIsOpen:t,setIsVisible:n,isVisible:r,setIsShutDown:o,setIsShuttingDown:i}=Pe(),l=[{name:"about",src:ul,alt:"aboutStart",label:"About Me"},{name:"work",src:cl,alt:"workStart",label:"My Work"},{name:"contact",src:Al,alt:"contactStart",label:"Contact"},{name:"recycle",src:po,alt:"RecycleStart",label:"Recycle Bin"}],a=()=>{i(!0),setTimeout(()=>{o(!0)},3e3)};return V(V0,{isOpen:e.start,"data-no-select":"true",children:[l.map(s=>V(DA,{onClick:()=>{t({...e,[s.name]:!0,start:!1}),n({...r,[s.name]:!0})},children:[x("img",{src:s.src,alt:s.alt}),x("p",{children:s.label})]},s.name)),x("img",{src:Z0,alt:"StartDash"}),V(DA,{onClick:a,children:[x("img",{src:J0,alt:"ShutDownStart"}),x("p",{children:"Shut Down"})]})]})},X0="/Portfolio/assets/timeModal-6454d07c.jpg",q0=G.section`
...
`,ry=()=>{const{isOpen:e,setIsOpen:t}=Pe(),n=zn();return V("article",{children:[x(QA,{onClick:()=>t({...e,time:!1}),right:n>992?15.5:n>768?11:8.5,children:"OK"}),x(QA,{onClick:()=>t({...e,time:!1}),right:n>992?8.2:n>768?6:4.5,children:"Cancel"})]})},oy=G.div`
  width: 181px;
  height: 181px;
  border-radius: 50%;
  position: absolute;
...
`,bA=({preloader:e})=>x("section",{children:V(Zy,{children:[x(Hy,{}),!e&&x("p",{children:"Windows is shutting down."})]})}),Vy="/Portfolio/assets/turnOn-e9c9c3b4.png",Wy=G.section`
  ${he({justify:"center",align:"center"})};
